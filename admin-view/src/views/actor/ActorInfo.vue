...
export default {
  ...
  methods: {
    getActorList() {
      ...
      const _this = this;
      axios.get('/Actor/sysActor', {params: _this.queryInfo}).then(resp => {
        console.log(resp)
    ...
    async addActor() {
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        await axios.post('/Actor/sysActor', JSON.stringify(_this.addForm)).then(resp => {
          console.log(resp)
    ...
    async showEditDialog(id) {
      const _this = this
      await axios.get('/Actor/sysActor/' + id).then(resp => {
        console.log(resp)
    ...
    async editActorInfo() {
      ...
      this.$refs.editFormRef.validate(async valid => {
        ...
        await axios.put('/Actor/sysActor', JSON.stringify(_this.editForm)).then(resp => {
          if (resp.data.code !== 200) {
    ...
    async multipleDelete(){
      ...
      console.log(ids)
      await axios.delete('/Actor/sysActor/' + ids).then(resp => {
        if (resp.data.code !== 200){
    ...
    async deleteActorById(id){
      ...
      console.log(id)
      await axios.delete('/Actor/sysActor/' + id).then(resp => {
        if (resp.data.code !== 200){
