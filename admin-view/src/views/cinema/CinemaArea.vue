...
export default {
  ...
  methods: {
    getCinemaAreaList() {
      const _this = this;
      axios.get('/Cinema/sysCinemaArea', {params: _this.queryInfo}).then(resp => {
        console.log(resp)
    ...
    addCinemaArea(){
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        await axios.post('/Cinema/sysCinemaArea', JSON.stringify(_this.addForm)).then(resp => {
          console.log(resp)
    ...
    showEditDialog(id){
      const _this = this
      axios.get('/Cinema/sysCinemaArea/' + id ).then(resp => {
        console.log(resp)
    ...
    editCinemaAreaInfo(){
      this.$refs.editFormRef.validate(async valid => {
        ...
        await axios.put('/Cinema/sysCinemaArea', JSON.stringify(_this.editForm)).then(resp => {
          if (resp.data.code !== 200){
    ...
    async multipleDelete(){
      ...
      await axios.delete('/Cinema/sysCinemaArea/' + ids).then(resp => {
        if (resp.data.code !== 200){
    ...
    async deleteCinemaAreaById(id){
      ...
      await axios.delete('/Cinema/sysCinemaArea/' + id).then(resp => {
        if (resp.data.code !== 200){
