      ...
      <div class="movie-info-detail clearfix">
        <div class="main-content">
          <div class="crumbs-nav-container">
            <a href="/welcome">喵喵电影</a> &gt; <a href="/movie">电影</a> &gt; {{actorInfo.actorName}}
          </div>
          <div class="module">
            <div class="mod-title">
              <h2>介绍</h2>
...
export default {
  ...
  methods:{
    async getActorInfo(){
      const { data: res} = await axios.get('/Actor/sysActor/find/' + this.actorId)
    ...
    async getRelationship() {
      ...
      const {data: res} = await axios.get('/Actor/sysActor', {params: queryInfo})
