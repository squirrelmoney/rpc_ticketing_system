...
export default {
  ...
  methods: {
    ...
    async getCinemaList(){
      ...
      const {data: res} = await axios.get('/Cinema/sysCinema', { params: this.queryInfo })
      if (res.code !== 200) return this.$message.error('获取服务器信息失败')
