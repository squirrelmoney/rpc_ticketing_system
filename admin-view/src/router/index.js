...
import echart  from "@/views/echart/myechart"
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/syslog', component: SysLog, meta: { btnPermission: 'admin' }},
      { path: '/echart', component: echart, meta: { btnPermission: 'admin' }},
      { path: '/zookeeper', component: zookeeper, meta: { btnPermission: 'admin' }}
...
router.beforeEach((to, from, next) =>{
  ...
  if(to.path == '/login' || to.path == '/404' || to.path == '/') return next();
