        ...
        <div class="movie-info-right">
          ...
          <div class="movie-info-score">
            <div class="movie-index">
              <span class="movie-index-title">喵喵口碑</span>
      ...
      <div class="movie-info-detail clearfix">
        <div class="main-content">
          <div class="crumbs-nav-container">
            <a href="/welcome">喵喵电影</a> &gt; <a href="/movie">电影</a> &gt; {{movieInfo.movieNameCn}}
          </div>
...
export default {
  ...
  methods:{
    async getMovieInfo(){
      const _this = this
      const {data : res} = await axios.get('/Movie/sysMovie/find/' + this.movieId)
    ...
    async submitComment(){
      ...
      const { data : res } = await axios.post('/Movie/sysMovieComment', JSON.stringify(this.commentForm))
