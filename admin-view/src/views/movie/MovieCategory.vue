...
export default {
  ...
  methods: {
    getMovieCategoryList() {
      const _this = this;
      axios.get('/Movie/sysMovieCategory', {params: _this.queryInfo}).then(resp => {
        console.log(resp)
    ...
    addMovieCategory(){
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        await axios.post('/Movie/sysMovieCategory', JSON.stringify(_this.addForm)).then(resp => {
          console.log(resp)
    ...
    showEditDialog(id){
      const _this = this
      axios.get('/Movie/sysMovieCategory/' + id ).then(resp => {
        console.log(resp)
    ...
    editMovieCategoryInfo(){
      this.$refs.editFormRef.validate(async valid => {
        ...
        await axios.put('/Movie/sysMovieCategory', JSON.stringify(_this.editForm)).then(resp => {
          if (resp.data.code !== 200){
    ...
    async multipleDelete(){
      ...
      await axios.delete('/Movie/sysMovieCategory/' + ids).then(resp => {
        if (resp.data.code !== 200){
    ...
    async deleteMovieCategoryById(id){
      ...
      await axios.delete('/Movie/sysMovieCategory/' + id).then(resp => {
        if (resp.data.code !== 200){
