      ...
      <div class="movie-info-detail clearfix">
        <div class="main-content">
          <div class="crumbs-nav-container">
            <a href="/welcome">喵喵电影</a> &gt; <a href="/cinema">影院</a> &gt; {{cinemaInfo.cinemaName}}
          </div>
          <!-- 当前影院上映的所有电影 -->
...
export default {
  ...
  methods:{
    async getCinemaMovieList(){
      const { data : res} = await axios.get('/Cinema/sysCinema/find/' + this.cinemaId)
    ...
    async getNewSessionList(){
      const { data : res} = await axios.get('/Cinema/sysCinema/find/' + this.cinemaId + '/' + this.activeMovie)
