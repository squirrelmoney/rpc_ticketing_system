<template>
  <div>
    <div class="main">
      <div class="board" v-for="(item, index) in americanBoxOfficeList">
        <div class="left">
...
export default {
  ...
  data(){
    return{
      ...
      americanBoxOfficeList: []
    }
  },
  created() {
    this.getAmericanBoxOfficeList()
  },
  methods:{
    async getAmericanBoxOfficeList(){
      const {data: resp} = await axios.get('/Movie/sysMovie/rankingList/3', {params: this.queryInfo})
      console.log(resp)
