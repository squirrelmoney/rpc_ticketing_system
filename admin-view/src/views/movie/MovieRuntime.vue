...
export default {
  ...
  methods: {
    getMovieRuntimeList() {
      const _this = this;
      axios.get('/Movie/sysMovieRuntime', {params: _this.queryInfo}).then(resp => {
        console.log(resp)
    ...
    addMovieRuntime(){
      ...
      this.$refs.addFormRef.validate(async valid => {
        ...
        await axios.post('/Movie/sysMovieRuntime', JSON.stringify(_this.addForm)).then(resp => {
          console.log(resp)
    ...
    showEditDialog(id){
      const _this = this
      axios.get('/Movie/sysMovieRuntime/' + id ).then(resp => {
        console.log(resp)
    ...
    editMovieRuntimeInfo(){
      this.$refs.editFormRef.validate(async valid => {
        ...
        await axios.put('/Movie/sysMovieRuntime', JSON.stringify(_this.editForm)).then(resp => {
          if (resp.data.code !== 200){
    ...
    async multipleDelete(){
      ...
      await axios.delete('/Movie/sysMovieRuntime/' + ids).then(resp => {
        if (resp.data.code !== 200){
    ...
    async deleteMovieRuntimeById(id){
      ...
      await axios.delete('/Movie/sysMovieRuntime/' + id).then(resp => {
        if (resp.data.code !== 200){
